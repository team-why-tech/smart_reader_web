...
public class UsersControllerTests
{
    ...
    public async Task GetAll_ReturnsOk()
    {
        ...
        {
            new(1, "Test", "test@test.com", "1234567890", null, 0, 1, null, 0, DateTime.UtcNow, DateTime.MinValue, 0, 0, 0, 0, 0, 0, 3, 0, 0, 0, 0, 0, 0, 0, "")
        };
    ...
    {
        // Arrange
        var user = new UserDto(1, "Test", "test@test.com", "1234567890", null, 0, 1, null, 0, DateTime.UtcNow, DateTime.MinValue, 0, 0, 0, 0, 0, 0, 3, 0, 0, 0, 0, 0, 0, 0, "");
